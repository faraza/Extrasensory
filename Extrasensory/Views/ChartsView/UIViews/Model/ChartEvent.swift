...
struct BarChartEvent{
    ...
    static var urgeSampleEvents:[BarChartEvent]{
        [
            BarChartEvent(hoursPassedSince8AM: 0, numberOfEvents: 110, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 1, numberOfEvents: 150, urgeFamilyType: .urge),
            ...
            BarChartEvent(hoursPassedSince8AM: 4, numberOfEvents: 40, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 5, numberOfEvents: 40, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 6, numberOfEvents: 0, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 7, numberOfEvents: 30, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 8, numberOfEvents: 80, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 9, numberOfEvents: 90, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 10, numberOfEvents: 200, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 11, numberOfEvents: 60, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 12, numberOfEvents: 30, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 13, numberOfEvents: 40, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 14, numberOfEvents: 90, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 15, numberOfEvents: 200, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 16, numberOfEvents: 10, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 17, numberOfEvents: 30, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 18, numberOfEvents: 40, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 19, numberOfEvents: 0, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 20, numberOfEvents: 10, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 21, numberOfEvents: 30, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 22, numberOfEvents: 80, urgeFamilyType: .urge),
            BarChartEvent(hoursPassedSince8AM: 23, numberOfEvents: 40, urgeFamilyType: .urge),
        ]
    }
    
    static var lapseSampleEvents:[BarChartEvent]{ //TODO: Lapse or urge
        [
            BarChartEvent(hoursPassedSince8AM: 0, numberOfEvents: 1, urgeFamilyType: .atomicLapse),
            BarChartEvent(hoursPassedSince8AM: 1, numberOfEvents: 3, urgeFamilyType: .atomicLapse),
            ...
            BarChartEvent(hoursPassedSince8AM: 4, numberOfEvents: 3, urgeFamilyType: .atomicLapse),
